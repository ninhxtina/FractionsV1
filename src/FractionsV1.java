 ...
 * CSS143 Kalmin
 */
import java.lang.String; //import to read strings
import java.io.FileInputStream; //import this class to take files
...
public class FractionsV1 {
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace(); //automated error response, helps trace where problem is
        }//end of try

        //set up variables
        String[] fractions = new String[100]; //String to take in fractions
        String[] split; //used to split the fractions
